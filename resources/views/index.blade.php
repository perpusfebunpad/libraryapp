...
<section class="h-full flex items-center bg-image-refenitiv bg-gray-500  bg-blend-multiply">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-unpad-light md:text-5xl lg:text-6xl dark:text-white">Database Refinitiv</h1>
        <p class="mb-8 text-lg font-normal text-unpad-light lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">Aplikasi database refinitiv merupakan aplikasi berbasis web yang bertujuan untuk melakukan booking jadwal penggunaan perpustakaan Fakultas Ekonomi Bisnis Universitas Padjajaran</p>
