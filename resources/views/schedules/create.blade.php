...
<section id="body" class="min-h-screen bg-gray-50">
    ...
    <main class="flex justify-center">
        <main class="container mx-auto px-4 py-8">
            <div class="max-w-lg mx-auto bg-white shadow-lg rounded-lg border border-gray-200 overflow-hidden">
                <div class="p-6 pb-3 border-b border-gray-100">
                    <h2 class="text-2xl font-semibold text-amber-800">Dapatkan jadwal penggunaan database refinitiv</h2>
                    <p class="text-gray-500 mt-1">Pilih tanggal dan sesi untuk menggunakan database perpustakaan</p>
                </div>
                <!-- Card Content -->
                <div class="p-6 space-y-6">
                    ...
                    <form class="space-y-3" action="/schedule" method="post">
                        ...
                        <button type="submit" class="w-full py-3 px-4 bg-amber-500 hover:bg-amber-600 text-white font-medium rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2">Daftarkan jadwal</button>
                    </form>
                </div>
            </div>
        </main>
