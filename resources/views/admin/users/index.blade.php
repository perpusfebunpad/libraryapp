...
<div class="mt-6 relative overflow-x-auto px-6">
    <div class="flex items-center md:justify-between">
        ...
        <div>
            ...
            <a href="/_/users/export" type="button" class="text-white bg-yellow-700 hover:bg-yellow-800   focus:outline-none focus:ring-4 focus:ring-yellow-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">
                Export
            </a>
        </div>
    </div>
