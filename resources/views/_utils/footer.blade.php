...
<footer class="bg-white dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl">
      <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
        <div>
            <h2 class="mb-6 text-xl font-semibold text-gray-900 uppercase dark:text-white">Contact</h2>
        ...
        <div>
            <h2 class="mb-6 text-xl font-semibold text-gray-900 uppercase dark:text-white">Related Links</h2>
            <ul class="text-unpad-dark font-light dark:text-gray-400 font-medium">
                <li class="mb-4">
        ...
        <div>
            <h2 class="mb-6 text-xl font-semibold text-gray-900 uppercase dark:text-white">Attribution</h2>
            <ul class="text-unpad-dark font-light dark:text-gray-400 font-medium">
                <li class="mb-4">
